...
class DishesModel: ObservableObject {
    ...
    func reload(_ coreDataContext:NSManagedObjectContext) async {
        ...
        do {
            ...
            let fullMenu = try JSONDecoder().decode(MenuJSON.self, from: data)
...
extension URLSession {
    ...
    func itemsTask(with url: URL, completionHandler: @escaping (MenuJSON?, URLResponse?, Error?) -> Void) -> URLSessionDataTask {
